...
def getOpenConnection(user='pks', password='pks', dbname='pks'): #def getOpenConnection(user='postgres', password='1234', dbname='ddsassignment2'):
    return psycopg2.connect("dbname='" + dbname + "' user='" + user + "' host='localhost' password='" + password + "'")

def createDB(dbname='ddsassignment2'): #def createDB(dbname='ddsassignment2'):
    """
    ...
    con = getOpenConnection(dbname='pks') #con = getOpenConnection(dbname='postgres') 
