...
#
__author__ = 'Pruthvi Kamarathi Satish'
...
RROBIN_TABLE_PREFIX = 'range_part' #'rrobin_part'
...
import Partition as MyAssignment  # TODO: Change the 'Assignment' to your filename
